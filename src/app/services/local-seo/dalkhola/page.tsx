...
export const metadata: Metadata = {
  title: "Digital Marketing Agency in Dalkhola | SEO, GBP, Instagram & Facebook Ads — Searchmetric",
  description: "Digital marketing for Dalkhola businesses. NH-27 junction connecting Bihar, Bengal & Northeast. SEO, GBP, Instagram ads, Facebook ads. Free audit +91 90801 35567.",
  keywords: "digital marketing Dalkhola, local SEO Dalkhola, Google Maps ranking Dalkhola, GBP Dalkhola, website development Dalkhola, Instagram ads Dalkhola, Facebook ads Dalkhola, performance marketing Dalkhola, lead generation Dalkhola, SEO company Dalkhola, social media marketing Dalkhola, Seemanchal digital marketing",
  alternates: { canonical: "/services/local-seo/dalkhola" },
  openGraph: {
    title: "Digital Marketing Agency in Dalkhola | SEO, GBP, Ads — Searchmetric",
    description: "Digital marketing for Dalkhola businesses. NH-27 junction connecting Bihar, Bengal & Northeast. SEO, GBP, Instagram ads, Facebook ads. Free audit +91 90801 35567.",
  ...
  twitter: {
    ...
    title: "Digital Marketing in Dalkhola — Searchmetric",
    description: "Digital marketing for Dalkhola businesses. NH-27 junction connecting Bihar, Bengal & Northeast. SEO, GBP, Instagram ads, Facebook ads. Free audit +91 90801 35567.",
  },
};
...
const citySchema = {
  ...
  "name": "Searchmetric — Digital Marketing Agency Dalkhola",
  "url": "https://searchmetric.in/services/local-seo/dalkhola",
  ...
  "areaServed": { "@type": "City", "name": "Dalkhola", "sameAs": "https://en.wikipedia.org/wiki/Dalkhola" },
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Can my Dalkhola business attract customers from Bihar and Assam?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. GBP service areas and Meta ad targeting cover Bihar, West Bengal, and Northeast India from one listing." } },
    { "@type": "Question", "name": "How competitive is Google Maps in Dalkhola?", "acceptedAnswer": { "@type": "Answer", "text": "Very low — one of our fastest ranking markets. Most businesses reach top 3 within 30–60 days." } },
    { "@type": "Question", "name": "Do you run Instagram and Facebook ads for Dalkhola?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — Meta campaigns targeting Dalkhola, Chopra, Raiganj, and the NH-27 corridor." } },
    { "@type": "Question", "name": "Do you serve all of Uttar Dinajpur?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — Raiganj, Chopra, Islampur, Itahar, and surrounding areas." } }
  ],
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Dalkhola", "item": "https://searchmetric.in/services/local-seo/dalkhola" },
  ],
};

const services = [
  { icon: "📍", title: "Local SEO & Google Maps", desc: "Rank in the top 3 on Google Maps for Dalkhola searches. GBP optimisation, citations, review generation, monthly reports.", color: "from-indigo-500 to-violet-600" },
  { icon: "🌐", title: "Website Development & SEO", desc: "Mobile-first website optimised for Dalkhola keywords. Ranks on Google and converts visitors into customers.", color: "from-sky-500 to-cyan-600" },
  { icon: "📸", title: "Instagram Marketing & Ads", desc: "Instagram Lead Ads and Reels content targeting Dalkhola audiences. Pre-filled forms, high conversion rates.", color: "from-pink-500 to-rose-600" },
  { icon: "👍", title: "Facebook Marketing & Ads", desc: "Facebook Lead campaigns targeting Dalkhola 25–50 age group. Hindi+English copy, local radius targeting.", color: "from-blue-500 to-indigo-600" },
  ...
  { icon: "📱", title: "Social Media Management", desc: "8–12 posts/month across Instagram and Facebook. Reels, Stories, captions — consistent local brand presence in Dalkhola.", color: "from-violet-500 to-purple-600" },
];

const faqs = [
  { q: "Can my Dalkhola business attract customers from Bihar and Assam?", a: "Yes. GBP service areas and Meta ad targeting cover Bihar, West Bengal, and Northeast India from one listing." },
  { q: "How competitive is Google Maps in Dalkhola?", a: "Very low — one of our fastest ranking markets. Most businesses reach top 3 within 30–60 days." },
  { q: "Do you run Instagram and Facebook ads for Dalkhola?", a: "Yes — Meta campaigns targeting Dalkhola, Chopra, Raiganj, and the NH-27 corridor." },
  { q: "Do you serve all of Uttar Dinajpur?", a: "Yes — Raiganj, Chopra, Islampur, Itahar, and surrounding areas." },
];

const nearbyAreas = ["Dalkhola Town", "Chopra", "Raiganj", "Islampur WB", "Itahar", "Karandighi", "Goalpokhar"];

export default function DalkholaPage() {
  return (
    <>
      ...
      <nav className="bg-slate-50 border-b border-slate-100 py-2" aria-label="Breadcrumb">
        <div className="container-pad">
          <ol className="flex flex-wrap items-center gap-1 text-xs text-slate-500">
            {[{ name: "Home", href: "/" }, { name: "Services", href: "/services" }, { name: "Dalkhola", href: "/services/local-seo/dalkhola" }].map((c, i, arr) => (
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900 py-20 md:py-28">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white mb-6">
                ...
                <span className="text-sm font-semibold">Dalkhola, Uttar Dinajpur</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                Digital Marketing Agency<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400">in Dalkhola</span>
              </h1>
              <p className="text-slate-300 text-lg mb-4 leading-relaxed">Dalkhola is the NH-27 junction connecting Bihar, West Bengal, and Northeast India. Your digital presence can capture customers from three states at once.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <Link href="/free-audit" className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-gradient-to-r from-orange-500 to-amber-600 text-white font-semibold rounded-xl shadow-xl hover:opacity-90 transition-all">
      ...
      <section className="section bg-gradient-to-b from-white to-slate-50">
        <div className="container-pad max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="badge bg-gradient-to-r from-orange-500 to-amber-600 text-white ring-0 mb-4">Our Services in Dalkhola</div>
            <h2 className="text-3xl md:text-4xl font-bold mb-3">Everything Your Dalkhola Business Needs Online</h2>
          ...
          <div className="mt-8 text-center">
            <Link href="/free-audit" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-600 text-white font-semibold rounded-xl shadow-lg hover:opacity-90 transition-all">
              Get Free Audit for Dalkhola <ArrowRight size={18} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-white">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-14 items-start">
            <div>
              <div className="badge bg-gradient-to-r from-orange-500 to-amber-600 text-white ring-0 mb-5">🎯 The Dalkhola Opportunity</div>
              <h2 className="text-3xl font-bold mb-5">Why Dalkhola Businesses Should Act Now</h2>
              <p className="text-slate-600 text-sm leading-relaxed mb-5">Dalkhola is positioned at the NH-27 junction — trucks from Assam, travellers from Katihar to Siliguri, and local Uttar Dinajpur residents all search Google here. Search volume is unusually high for a town of this size. Digital competition is near zero — fastest-ranking market we operate in.</p>
            ...
            <div className="card card-pad">
              <h3 className="font-bold text-lg mb-5">Why Choose Searchmetric for Dalkhola</h3>
      ...
      <section className="section bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900 text-white">
        <div className="container-pad text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Grow Your Dalkhola Business Online?</h2>
