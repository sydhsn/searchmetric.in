...
export const metadata: Metadata = {
  title: "Digital Marketing Agency in Siliguri | SEO, GBP, Instagram & Facebook Ads — Searchmetric",
  description: "Digital marketing for Siliguri businesses. Gateway city for Bihar, Bengal & Northeast. SEO, GBP, Instagram ads, Facebook ads, performance marketing. Free audit +91 90801 35567.",
  keywords: "digital marketing Siliguri, local SEO Siliguri, Google Maps ranking Siliguri, GBP Siliguri, website development Siliguri, Instagram ads Siliguri, Facebook ads Siliguri, performance marketing Siliguri, lead generation Siliguri, SEO company Siliguri, social media marketing Siliguri, Seemanchal digital marketing",
  alternates: { canonical: "/services/local-seo/siliguri" },
  openGraph: {
    title: "Digital Marketing Agency in Siliguri | SEO, GBP, Ads — Searchmetric",
    description: "Digital marketing for Siliguri businesses. Gateway city for Bihar, Bengal & Northeast. SEO, GBP, Instagram ads, Facebook ads, performance marketing. Free audit +91 90801 35567.",
  ...
  twitter: {
    ...
    title: "Digital Marketing in Siliguri — Searchmetric",
    description: "Digital marketing for Siliguri businesses. Gateway city for Bihar, Bengal & Northeast. SEO, GBP, Instagram ads, Facebook ads, performance marketing. Free audit +91 90801 35567.",
  },
};
...
const citySchema = {
  ...
  "@type": "LocalBusiness",
  "@id": "https://searchmetric.in/services/local-seo/siliguri",
  "name": "Searchmetric — Digital Marketing Agency Siliguri",
  "url": "https://searchmetric.in/services/local-seo/siliguri",
  ...
  "areaServed": { "@type": "City", "name": "Siliguri", "sameAs": "https://en.wikipedia.org/wiki/Siliguri" },
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Is SEO competitive in Siliguri?", "acceptedAnswer": { "@type": "Answer", "text": "More competitive than Katihar or Purnea, but still far below what you'd face in Kolkata or Delhi. Many categories have significant ranking opportunities." } },
    { "@type": "Question", "name": "Can you target Northeast India customers from Siliguri?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — Siliguri's position means GBP service areas and Meta ad targeting can cover Assam, Sikkim, and parts of Northeast India effectively." } },
    { "@type": "Question", "name": "Do you run Instagram and Facebook ads in Siliguri?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — Meta campaigns targeting Siliguri, Jalpaiguri, and the broader Terai-Dooars market." } },
    { "@type": "Question", "name": "What types of Siliguri businesses do you work with?", "acceptedAnswer": { "@type": "Answer", "text": "Hotels, restaurants, clinics, coaching centres, retail shops, logistics, real estate — any business serving local or transit customers." } }
  ],
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Siliguri", "item": "https://searchmetric.in/services/local-seo/siliguri" },
  ],
};

const services = [
  { icon: "📍", title: "Local SEO & Google Maps", desc: "Rank in the top 3 on Google Maps for Siliguri searches. GBP optimisation, citations, review generation, monthly reports.", color: "from-indigo-500 to-violet-600" },
  { icon: "🌐", title: "Website Development & SEO", desc: "Mobile-first website optimised for Siliguri keywords. Ranks on Google and converts visitors into customers.", color: "from-sky-500 to-cyan-600" },
  { icon: "📸", title: "Instagram Marketing & Ads", desc: "Instagram Lead Ads and Reels content targeting Siliguri audiences. Pre-filled forms, high conversion rates.", color: "from-pink-500 to-rose-600" },
  { icon: "👍", title: "Facebook Marketing & Ads", desc: "Facebook Lead campaigns targeting Siliguri 25–50 age group. Hindi+English copy, local radius targeting.", color: "from-blue-500 to-indigo-600" },
  ...
  { icon: "📱", title: "Social Media Management", desc: "8–12 posts/month across Instagram and Facebook. Reels, Stories, captions — consistent local brand presence in Siliguri.", color: "from-violet-500 to-purple-600" },
];

const faqs = [
  { q: "Is SEO competitive in Siliguri?", a: "More competitive than Katihar or Purnea, but still far below what you'd face in Kolkata or Delhi. Many categories have significant ranking opportunities." },
  { q: "Can you target Northeast India customers from Siliguri?", a: "Yes — Siliguri's position means GBP service areas and Meta ad targeting can cover Assam, Sikkim, and parts of Northeast India effectively." },
  { q: "Do you run Instagram and Facebook ads in Siliguri?", a: "Yes — Meta campaigns targeting Siliguri, Jalpaiguri, and the broader Terai-Dooars market." },
  { q: "What types of Siliguri businesses do you work with?", a: "Hotels, restaurants, clinics, coaching centres, retail shops, logistics, real estate — any business serving local or transit customers." },
];

const nearbyAreas = ["Siliguri City", "Matigara", "Naxalbari", "Bagdogra", "Jalpaiguri", "New Jalpaiguri", "Sevoke"];
...
export default function SiliguriPage() {
  return (
    <>
      ...
      <nav className="bg-slate-50 border-b border-slate-100 py-2" aria-label="Breadcrumb">
        <div className="container-pad">
          <ol className="flex flex-wrap items-center gap-1 text-xs text-slate-500">
            {[{ name: "Home", href: "/" }, { name: "Services", href: "/services" }, { name: "Siliguri", href: "/services/local-seo/siliguri" }].map((c, i, arr) => (
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 py-20 md:py-28">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white mb-6">
                ...
                <span className="text-sm font-semibold">Siliguri, West Bengal</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                Digital Marketing Agency<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-400">in Siliguri</span>
              </h1>
              <p className="text-slate-300 text-lg mb-4 leading-relaxed">Siliguri is the gateway to Northeast India — a crossroads for Bihar, Bengal, Sikkim, Assam, and Bhutan. The biggest digital market in our coverage area.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <Link href="/free-audit" className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-gradient-to-r from-teal-500 to-emerald-600 text-white font-semibold rounded-xl shadow-xl hover:opacity-90 transition-all">
                  Free Siliguri SEO Audit <ArrowRight size={18} />
                </Link>
      ...
      <section className="section bg-gradient-to-b from-white to-slate-50">
        <div className="container-pad max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="badge bg-gradient-to-r from-teal-500 to-emerald-600 text-white ring-0 mb-4">Our Services in Siliguri</div>
            <h2 className="text-3xl md:text-4xl font-bold mb-3">Everything Your Siliguri Business Needs Online</h2>
          ...
          <div className="mt-8 text-center">
            <Link href="/free-audit" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-teal-500 to-emerald-600 text-white font-semibold rounded-xl shadow-lg hover:opacity-90 transition-all">
              Get Free Audit for Siliguri <ArrowRight size={18} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-white">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-14 items-start">
            <div>
              <div className="badge bg-gradient-to-r from-teal-500 to-emerald-600 text-white ring-0 mb-5">🎯 The Siliguri Opportunity</div>
              <h2 className="text-3xl font-bold mb-5">Why Siliguri Businesses Should Act Now</h2>
              <p className="text-slate-600 text-sm leading-relaxed mb-5">Siliguri is a major city with serious commercial density and high Google search volume. While competition is higher than smaller Seemanchal towns, many categories are still underserved. Its position as gateway to Northeast India means service areas and ad targeting can cover an enormous geographic market.</p>
            ...
            <div className="card card-pad">
              <h3 className="font-bold text-lg mb-5">Why Choose Searchmetric for Siliguri</h3>
      ...
      <section className="section bg-slate-50">
        <div className="container-pad max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-2">Areas We Cover in & Around Siliguri</h2>
      ...
      <section className="section bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 text-white">
        <div className="container-pad text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Grow Your Siliguri Business Online?</h2>
