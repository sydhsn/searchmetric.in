...
export const metadata: Metadata = {
  title: "Local SEO in Kishanganj | Google Maps Ranking & Digital Marketing — Searchmetric",
  description: "Local SEO for Kishanganj businesses. Rank on Google Maps, attract Bihar and West Bengal customers. Tea gardens, trade, retail — we cover all sectors. Free audit.",
  keywords: "local SEO Kishanganj, SEO agency Kishanganj, digital marketing Kishanganj, Google Maps ranking Kishanganj, Google Business Profile Kishanganj, GBP Kishanganj, SEO company Kishanganj Bihar, Instagram marketing Kishanganj, Facebook ads Kishanganj, lead generation Kishanganj, best digital marketing agency Kishanganj, Seemanchal SEO, near me SEO Kishanganj",
  alternates: { canonical: "/services/local-seo/kishanganj" },
  openGraph: {
    title: "Local SEO in Kishanganj | Google Maps Ranking — Searchmetric",
    description: "Rank your Kishanganj business on Google Maps. Capture cross-border customers from Bihar and Bengal.",
  ...
  twitter: {
    ...
    title: "Local SEO in Kishanganj — Searchmetric",
    description: "Rank your Kishanganj business on Google Maps. Capture cross-border customers from Bihar and Bengal.",
  },
};
...
const citySchema = {
  ...
  "name": "Searchmetric — Local SEO Agency Kishanganj",
  "url": "https://searchmetric.in/services/local-seo/kishanganj",
  ...
  "areaServed": { "@type": "City", "name": "Kishanganj" },
  "priceRange": "₹₹",
};
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can local SEO attract customers from West Bengal too?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We configure your GBP service areas to cover Bihar and nearby West Bengal areas so you appear in searches from both sides of the border." }
    },
    {
      "@type": "Question",
      "name": "How fast can I rank in Kishanganj?",
      "acceptedAnswer": { "@type": "Answer", "text": "Very fast — Kishanganj has very low SEO competition. Many businesses can reach the top 3 within 4–6 weeks." }
    },
    {
      "@type": "Question",
      "name": "Do you work with tea and agriculture businesses?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes — garden suppliers, agri-input shops, equipment dealers, and related services can all rank and attract B2B and B2C customers via Google." }
    },
    {
      "@type": "Question",
      "name": "What about hotels and guesthouses in Kishanganj?",
      "acceptedAnswer": { "@type": "Answer", "text": "Hotels here benefit enormously — travellers on the NH-27 route search for accommodation on Google Maps. We help you appear at the top of those searches." }
    }
  ],
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 4, "name": "Kishanganj", "item": "https://searchmetric.in/services/local-seo/kishanganj" },
  ],
};
...
const processSteps = [
  { step: "01", title: "Free Audit", desc: "We audit your Google presence, check Kishanganj competitors, and identify your fastest ranking opportunities — at zero cost." },
...
const includes = [
  ...
  { icon: "🔑", title: "Kishanganj Keyword Research", desc: "We find exactly what Kishanganj customers search for and build your SEO around those exact phrases." },
...
const faqs = [
  { q: "Can local SEO attract customers from West Bengal too?", a: "Yes. We configure your GBP service areas to cover Bihar and nearby West Bengal areas so you appear in searches from both sides of the border." },
  { q: "How fast can I rank in Kishanganj?", a: "Very fast — Kishanganj has very low SEO competition. Many businesses can reach the top 3 within 4–6 weeks." },
  { q: "Do you work with tea and agriculture businesses?", a: "Yes — garden suppliers, agri-input shops, equipment dealers, and related services can all rank and attract B2B and B2C customers via Google." },
  { q: "What about hotels and guesthouses in Kishanganj?", a: "Hotels here benefit enormously — travellers on the NH-27 route search for accommodation on Google Maps. We help you appear at the top of those searches." },
];
  ...
  return (
    <>
      ...
      <nav className="bg-slate-50 border-b border-slate-100 py-2" aria-label="Breadcrumb">
        <div className="container-pad">
          <ol className="flex flex-wrap items-center gap-1 text-xs text-slate-500">
            {[{ name: "Home", href: "/" }, { name: "Services", href: "/services" }, { name: "Local SEO", href: "/services/local-seo" }, { name: "Kishanganj", href: "/services/local-seo/kishanganj" }].map((crumb, i, arr) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white mb-6">
                ...
                <span className="text-sm font-semibold">Local SEO · Google Maps · Kishanganj, Bihar</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                Rank Your Kishanganj Business<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-pink-400">#1 on Google Maps</span>
              </h1>
              <p className="text-lg text-slate-300 mb-8 leading-relaxed">Kishanganj sits on the Bihar–West Bengal border. The right Google presence captures customers from both sides — and few businesses here have done it yet.</p>
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <Link href="/contact" className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-semibold rounded-xl shadow-xl transition-all hover:opacity-90">
      ...
      <section className="bg-white border-b border-slate-100 py-8">
        <div className="container-pad">
          <p className="text-center text-sm text-slate-500 font-medium mb-4">We help these Kishanganj businesses rank on Google:</p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 text-slate-700 text-sm font-semibold mb-5">
                🎯 The Kishanganj SEO Opportunity
              </div>
              ...
              <div className="mt-8">
                <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-semibold rounded-xl hover:opacity-90 transition-all">
            ...
            <div className="space-y-4">
              {[
                { icon: <Search size={20} />, label: "Google Search Visibility", desc: "Appear when Kishanganj locals search for your service category" },
                ...
                <div key={i} className="card card-pad flex items-center gap-4 group hover:border-slate-300 transition-all">
                  <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-rose-500 to-pink-600 text-white grid place-items-center flex-shrink-0">
                    {item.icon}
                  </div>
                  <div>
      ...
      <section className="section bg-white">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <div className="badge bg-gradient-to-r from-rose-500 to-pink-600 text-white ring-0 mb-4">Our Process</div>
            <h2 className="text-3xl md:text-4xl font-bold mb-3">How We Rank Your Kishanganj Business on Google</h2>
            <p className="text-slate-500">Clear, transparent process — no black-box tactics, no confusion.</p>
          </div>
          <div className="grid md:grid-cols-5 gap-4">
            {processSteps.map((step, i) => (
              <div key={i} className="text-center">
                <div className="h-14 w-14 rounded-full bg-gradient-to-br from-rose-500 to-pink-600 text-white font-bold text-lg grid place-items-center mx-auto mb-4 shadow-lg">
                  {step.step}
                </div>
      ...
      <section className="section bg-slate-50">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <div className="badge bg-gradient-to-r from-rose-500 to-pink-600 text-white ring-0 mb-4">Full Service</div>
            <h2 className="text-3xl font-bold">Everything Included for Kishanganj Local SEO</h2>
      ...
      <section className="section bg-white">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="badge bg-gradient-to-r from-rose-500 to-pink-600 text-white ring-0 mb-5">100% White-Hat SEO</div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-rose-500 to-pink-600 text-white grid place-items-center flex-shrink-0">
                      {item.icon}
                    </div>
                    <div>
      ...
      <section className="section bg-slate-50">
        <div className="container-pad max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-500 text-sm mb-6">We target customers searching across all parts of Kishanganj and nearby areas.</p>
          <div className="flex flex-wrap justify-center gap-3">
            {nearbyAreas.map((area) => (
              <span key={area} className="px-4 py-2 rounded-full bg-rose-50 text-rose-700 text-sm font-medium border border-rose-200">
                📍 {area}
              </span>
            ))}
          </div>
      ...
      <section className="section bg-gradient-to-br from-slate-900 via-rose-900 to-slate-900 text-white">
        <div className="container-pad text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Rank #1 on Google Maps in Kishanganj?</h2>
