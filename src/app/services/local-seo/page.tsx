        ...
        <div className="container-pad relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white shadow-lg mb-6">
              <MapPin size={16} />
              <span className="text-sm font-semibold">Local Visibility</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              {localSEOService.results.map((result, index) => (
      ...
      <section className="section bg-gradient-to-b from-white via-slate-50 to-white">
        <div className="container-pad">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="badge bg-gradient-to-r from-indigo-600 to-violet-600 text-white ring-0 mb-4">
                Service Overview
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Get Found by <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">Local Customers</span>
              </h2>
              ...
              <div className="mt-8">
                <Link href="/contact" className="btn-primary inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-violet-600">
            ...
            <div className="relative">
              <div className="aspect-video rounded-3xl overflow-hidden relative bg-gradient-to-br from-indigo-50 to-violet-50">
                <Image 
                  src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&q=80"
                  alt="Google Maps search results showing local businesses"
                  fill
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl">
                <div className="text-4xl font-bold text-indigo-700">300-500%</div>
                <div className="text-sm text-slate-600">More Map Views</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section bg-slate-50">
        <div className="container-pad">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Complete <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-fuchsia-600">Local Optimization</span>
            </h2>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {localSEOService.features.map((feature, index) => (
      ...
      <section className="section bg-gradient-to-b from-white via-slate-50 to-white">
        <div className="container-pad">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              How We Dominate <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-fuchsia-600">Local Search</span>
            </h2>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {localSEOService.process.map((step, index) => (
              <div key={index} className="text-center">
                <div className="relative mb-6">
                  ...
                  {index < localSEOService.process.length - 1 && (
      ...
      <section className="section bg-slate-50">
        <div className="container-pad">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-fuchsia-600">Local Presence</span>
            </h2>
            <p className="text-lg text-slate-600">
              All-inclusive packages with guaranteed results. No hidden fees.
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            {localSEOService.packages.map((pkg, index) => (
              <div 
                key={index}
          ...
          <div className="text-center mt-8 text-sm text-slate-600">
            *All plans include a 30-day money-back guarantee. Results typically visible in 2-3 months.
          </div>
        </div>
      </section>
      ...
      <section className="section bg-gradient-to-b from-white via-slate-50 to-white">
        <div className="container-pad">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-4">
              {localSEOService.faqs.map((faq, index) => (
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  <p className="text-slate-300 mb-6">
                    Get your free local SEO audit and discover how to rank higher on Google Maps.
                  </p>
                ...
                <div className="rounded-2xl bg-white/10 p-6">
                  <div className="text-center">
                    ...
                    <div className="text-sm opacity-80">Local SEO Audit</div>
                  </div>
                  <div className="grid grid-cols-2 gap-4 mt-6">
                    <div className="text-center">
                      <div className="text-lg font-semibold">Competitor Analysis</div>
                      <div className="text-xs opacity-80">Local Competitors</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold">GBP Score</div>
                      <div className="text-xs opacity-80">Optimization Report</div>
                    </div>
                  </div>
                </div>
              </div>
