...
export const metadata: Metadata = {
  title: "Local SEO in Baisi | Google Maps Ranking & Digital Marketing — Searchmetric",
  description: "Local SEO for Baisi businesses in Purnea district. We're based here — Hospital Road, Purab Chowk, Baisi. Free audit, no commitment. Call +91 90801 35567.",
  keywords: "local SEO Baisi, SEO agency Baisi, digital marketing Baisi, Google Maps ranking Baisi, Google Business Profile Baisi, GBP Baisi, SEO company Baisi Bihar, Instagram marketing Baisi, Facebook ads Baisi, lead generation Baisi, best digital marketing agency Baisi, Seemanchal SEO, near me SEO Baisi",
  alternates: { canonical: "/services/local-seo/baisi" },
  openGraph: {
    title: "Local SEO in Baisi | Google Maps Ranking — Searchmetric",
    description: "We're based in Baisi. Get your Baisi business to the top of Google Maps — free audit.",
  ...
  twitter: {
    ...
    title: "Local SEO in Baisi — Searchmetric",
    description: "We're based in Baisi. Get your Baisi business to the top of Google Maps — free audit.",
  },
};
...
const citySchema = {
  ...
  "name": "Searchmetric — Local SEO Agency Baisi",
  "url": "https://searchmetric.in/services/local-seo/baisi",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Searchmetric is based in Baisi — does that help me?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes — we know Baisi's market personally. Local search patterns, competition, peak seasons, and the right keywords. You won't get that from any agency in Delhi or Patna." }
    },
    {
      "@type": "Question",
      "name": "Can Baisi businesses rank on Google?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes, and faster than most places. SEO competition in Baisi is near zero. If you optimise your profile, you'll rank at the top almost immediately." }
    },
    {
      "@type": "Question",
      "name": "Can you visit my business physically?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes — since we're based in Baisi, we can arrange in-person consultations. Call or WhatsApp +91 90801 35567." }
    },
    {
      "@type": "Question",
      "name": "Do I need a website?",
      "acceptedAnswer": { "@type": "Answer", "text": "No. Your Google Business Profile alone is enough to rank on Google Maps. A website helps later, but it's not required from day one." }
    }
  ],
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 4, "name": "Baisi", "item": "https://searchmetric.in/services/local-seo/baisi" },
  ],
};
...
const processSteps = [
  { step: "01", title: "Free Audit", desc: "We audit your Google presence, check Baisi competitors, and identify your fastest ranking opportunities — at zero cost." },
...
const includes = [
  ...
  { icon: "🔑", title: "Baisi Keyword Research", desc: "We find exactly what Baisi customers search for and build your SEO around those exact phrases." },
...
const faqs = [
  { q: "Searchmetric is based in Baisi — does that help me?", a: "Yes — we know Baisi's market personally. Local search patterns, competition, peak seasons, and the right keywords. You won't get that from any agency in Delhi or Patna." },
  { q: "Can Baisi businesses rank on Google?", a: "Yes, and faster than most places. SEO competition in Baisi is near zero. If you optimise your profile, you'll rank at the top almost immediately." },
  { q: "Can you visit my business physically?", a: "Yes — since we're based in Baisi, we can arrange in-person consultations. Call or WhatsApp +91 90801 35567." },
  { q: "Do I need a website?", a: "No. Your Google Business Profile alone is enough to rank on Google Maps. A website helps later, but it's not required from day one." },
];
  ...
  return (
    <>
      ...
      <nav className="bg-slate-50 border-b border-slate-100 py-2" aria-label="Breadcrumb">
        <div className="container-pad">
          <ol className="flex flex-wrap items-center gap-1 text-xs text-slate-500">
            {[{ name: "Home", href: "/" }, { name: "Services", href: "/services" }, { name: "Local SEO", href: "/services/local-seo" }, { name: "Baisi", href: "/services/local-seo/baisi" }].map((crumb, i, arr) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white mb-6">
                ...
                <span className="text-sm font-semibold">Local SEO · Google Maps · Baisi, Purnea District</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                Rank Your Baisi Business<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400">#1 on Google Maps</span>
              </h1>
              <p className="text-lg text-slate-300 mb-8 leading-relaxed">Baisi is our home. We know this market better than any agency. Let us put your business at the top of Google Maps.</p>
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <Link href="/contact" className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-gradient-to-r from-violet-500 to-purple-600 text-white font-semibold rounded-xl shadow-xl transition-all hover:opacity-90">
      ...
      <section className="bg-white border-b border-slate-100 py-8">
        <div className="container-pad">
          <p className="text-center text-sm text-slate-500 font-medium mb-4">We help these Baisi businesses rank on Google:</p>
        ...
        <div className="container-pad max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="mt-8">
                <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-violet-500 to-purple-600 text-white font-semibold rounded-xl hover:opacity-90 transition-all">
            ...
            <div className="space-y-4">
              {[
                { icon: <Search size={20} />, label: "Google Search Visibility", desc: "Appear when Baisi locals search for your service category" },
                ...
                <div key={i} className="card card-pad flex items-center gap-4 group hover:border-slate-300 transition-all">
                  <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 text-white grid place-items-center flex-shrink-0">
                    {item.icon}
                  </div>
                  <div>
      ...
      <section className="section bg-white">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <div className="badge bg-gradient-to-r from-violet-500 to-purple-600 text-white ring-0 mb-4">Our Process</div>
            <h2 className="text-3xl md:text-4xl font-bold mb-3">How We Rank Your Baisi Business on Google</h2>
            <p className="text-slate-500">Clear, transparent process — no black-box tactics, no confusion.</p>
          </div>
          <div className="grid md:grid-cols-5 gap-4">
            {processSteps.map((step, i) => (
              <div key={i} className="text-center">
                <div className="h-14 w-14 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 text-white font-bold text-lg grid place-items-center mx-auto mb-4 shadow-lg">
                  {step.step}
                </div>
      ...
      <section className="section bg-slate-50">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <div className="badge bg-gradient-to-r from-violet-500 to-purple-600 text-white ring-0 mb-4">Full Service</div>
            <h2 className="text-3xl font-bold">Everything Included for Baisi Local SEO</h2>
      ...
      <section className="section bg-white">
        <div className="container-pad max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="badge bg-gradient-to-r from-violet-500 to-purple-600 text-white ring-0 mb-5">100% White-Hat SEO</div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 text-white grid place-items-center flex-shrink-0">
                      {item.icon}
                    </div>
                    <div>
      ...
      <section className="section bg-slate-50">
        <div className="container-pad max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-500 text-sm mb-6">We target customers searching across all parts of Baisi and nearby areas.</p>
          <div className="flex flex-wrap justify-center gap-3">
            {nearbyAreas.map((area) => (
              <span key={area} className="px-4 py-2 rounded-full bg-violet-50 text-violet-700 text-sm font-medium border border-violet-200">
                📍 {area}
              </span>
            ))}
          </div>
        ...
        <div className="container-pad max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[{ name: "Katihar", href: "/services/local-seo/katihar" }, { name: "Purnea", href: "/services/local-seo/purnea" }, { name: "Kishanganj", href: "/services/local-seo/kishanganj" }, { name: "Barsoi", href: "/services/local-seo/barsoi" }, { name: "Baisi", href: "/services/local-seo/baisi" }, { name: "Dalkhola", href: "/services/local-seo/dalkhola" }, { name: "Siliguri", href: "/services/local-seo/siliguri" }].filter(c => c.name !== "Baisi").map((city) => (
              <Link key={city.name} href={city.href} className="px-5 py-2 rounded-full border border-violet-200 text-violet-700 text-sm font-medium hover:bg-violet-50 transition-all">
                Local SEO {city.name}
              </Link>
            ))}
          </div>
      ...
      <section className="section bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900 text-white">
        <div className="container-pad text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Rank #1 on Google Maps in Baisi?</h2>
