    ...
    <>
      ...
      <section className="section">
        <div className="container-pad">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              What Happens <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-fuchsia-600">Next?</span>
            </h2>
            <p className="text-lg text-slate-600">
            ...
            {[
              {
                ...
                description: "30-minute free consultation to understand your business goals and challenges.",
                icon: <MessageCircle size={24} className="text-brand-600" />
              },
              {
                step: "02",
                title: "Custom Strategy",
                description: "We create a tailored digital marketing plan with clear objectives and timelines.",
                icon: <Calendar size={24} className="text-fuchsia-600" />
              },
              {
                step: "03",
                title: "Onboarding",
                description: "Smooth transition with dedicated account manager and implementation team.",
                icon: <Users size={24} className="text-purple-600" />
              }
            ].map((step) => (
              <div key={step.step} className="text-center">
                <div className="relative">
                  <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-brand-50 to-fuchsia-50 grid place-items-center text-3xl font-bold text-brand-700 mx-auto mb-4">
                    {step.step}
                  </div>
                  <div className="absolute -top-2 -right-2 h-10 w-10 rounded-xl bg-white border border-slate-200 grid place-items-center shadow-md">
                    {step.icon}
                  </div>
                </div>
      ...
      <section className="section bg-gradient-to-r from-slate-900 to-slate-800">
        <div className="container-pad">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex flex-col sm:flex-row items-center gap-6 bg-white/10 backdrop-blur-xl rounded-2xl p-6">
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-xl bg-white/20 grid place-items-center">
                  <Phone size={24} className="text-white" />
                </div>
                <div className="text-left">
                  <div className="text-sm text-slate-300">Call us now</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xl font-bold text-white">{contactInfo.email}</div>
                </div>
              </div>
            </div>
          </div>
